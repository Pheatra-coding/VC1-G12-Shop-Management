...
<div class="container">
    ...
    <form action="/products/update" <?= $product['id'] ?> method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="date" class="form-control" id="endDate" name="end_date" value="<?= $product['end_date'] ?>"  required>
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="file" class="form-control" id="profile_image" name="image" accept="image/*" onchange="previewImage(event) "value="<?= $product['image'] ?>">
            <div class="mt-3">
