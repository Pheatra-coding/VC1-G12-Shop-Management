              ...
              <div class="card info-card revenue-card">
                <div class="filter">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                    ...
                    <li><a class="dropdown-item" href="#" onclick="showProfit('daily')">Today</a></li>
                    <li><a class="dropdown-item" href="#" onclick="showProfit('weekly')">This Week</a></li>
                    <li><a class="dropdown-item" href="#" onclick="showProfit('monthly')">This Month</a></li>
                  </ul>
                </div>

                <div class="card-body">
                  <h5 class="card-title">Net Profit <span id="profit-period">| Today</span></h5>
                  <div class="d-flex align-items-center">
                    <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                      <i class="bi bi-currency-dollar"></i>
                    </div>
                    <div class="ps-3">
                      <h6 id="profit-amount">$<?php echo number_format(isset($dailyProfit['total']) ? $dailyProfit['total'] : 0, 2); ?></h6>
                      <span id="profit-percentage" class="small pt-1 fw-bold text-success">
                        <?php echo isset($dailyProfit['percentage']) ? $dailyProfit['percentage'] : 0; ?>%
                      </span>
                      <span id="profit-trend" class="text-muted small pt-2 ps-1">
                        <?php echo isset($dailyProfit['trend']) ? ucfirst($dailyProfit['trend']) : 'No change'; ?>
                      </span>
                    </div>
                  </div>
                </div>
